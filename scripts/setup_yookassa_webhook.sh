...
docker logs --tail=10 pizzanat-app 2>/dev/null | grep -i yookassa || echo "Логи ЮКасса не найдены"
...
echo ""
echo "4. 🔍 Мониторинг:"
echo "   - Следите за логами: docker logs -f pizzanat-app | grep -i yookassa"
