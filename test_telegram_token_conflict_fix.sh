...
if grep -q "TELEGRAM_BOT_USERNAME: \${TELEGRAM_BOT_USERNAME:-PizzaNatBot}" docker-compose.yml; then
    print_test_result "Username основного бота" "PASS" "@PizzaNatBot"
else
...
if grep -q "TELEGRAM_ADMIN_BOT_USERNAME: \${TELEGRAM_ADMIN_BOT_USERNAME:-PizzaNatOrders_bot}" docker-compose.yml; then
    print_test_result "Username админского бота" "PASS" "@PizzaNatOrders_bot"
else
...
echo "   - @PizzaNatBot (пользовательский): 7819187384:..."
echo "   - @PizzaNatOrders_bot (админский): 8052456616:..."
