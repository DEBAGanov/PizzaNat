...
BEGIN
    ...
    VALUES
        ('Пицца Маргарита', 'Классическая итальянская пицца с томатным соусом и сыром "Моцарелла" и помидорами. Вес 580 гр.', 400.00, 450, pizza_category_id, 'products/pizza_margarita.png', true, false, null),
        ('Грибная пицца', 'Пицца с шампиньонами и томатным соусом, с сыром "Моцарелла" и ветчиной. Вес 600 гр.', 490.00, 470, pizza_category_id, 'products/pizza_gribnaya.png', true, false, null),
        ('Сырная пицца', 'Пицца с четырьмя видами сыра (соус томатный, "Моцарелла", "Голландский", "Пармезан", "Масдам". Вес 450 гр.)', 500.00, 460, pizza_category_id, 'products/pizza_4_chees.png', true, false, null),
        ('Пицца Салями', 'Пицца с салями и сыром (соус томатный, сыр "Моцарелла", колбаса, помидоры. Вес 580 гр.)', 520.00, 480, pizza_category_id, 'products/pizza_peperoni.png', true, false, null),
        ('Пицца Пепперони', 'Пицца с пепперони и сыром (соус томатный, сыр "Моцарелла", пеперони. Вес 600 гр.)', 490.00, 480, pizza_category_id, 'products/pizza_peperoni.png', true, false, null),
        ('Пицца Цезарь', 'Фирменная пицца с соусом Цезарь (соус Цезарь, сыр, курица, помидоры, салат. Вес 690 гр.)', 500.00, 500, pizza_category_id, 'products/pizza_mario.png', true, false, null),
        ('Гавайская пицца', 'Пицца с курицей и ананасами (соус сливочный, сыр "Моцарелла", курица, ананасы. Вес 600 гр.)', 510.00, 470, pizza_category_id, 'products/pizza_gavaiyaskay.png', true, false, null),
        ('Мясная пицца', 'Пицца с ассорти из мясных ингредиентов (соус томатный, сыр "Моцарелла", курица, колбаски, салями, ветчина. Вес 650 гр.)', 540.00, 520, pizza_category_id, 'products/pizza_mzysnay.png', true, false, null),
        ('Домашняя пицца', 'Пицца домашняя (соус томатный, сыр "Моцарелла", колбсалями, ветчина, помидоры, огурец маринованный, лук. Вес 610 гр. )', 510.00, 490, pizza_category_id, 'products/pizza_5_chees.png', true, false, null),
        ...
        ('Груша с горогонзолой', 'Пицца груша с Горогонзолой (соус сливочный, сыр "Моцарелла", груша, сыр Горгонзола. Вес 570 гр.)', 470.00, 490, pizza_category_id, 'products/pizza_tom_yam.png', true, false, null),
        ('Пицца конструктор', 'Пицца из двух видов пицц на выбор. Вес 570 гр.', 550.00, 490, pizza_category_id, 'products/pizza_tom_yam.png', true, false, null)
    ON CONFLICT (name) DO NOTHING;
